...
import 'package:biblioteca_app/views/usuario/usuario_from_view.dart';
  ...
  void _delete(UsuarioModel usuario) async {
    ...
    final confirmar = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text("Deseja Realmete excluir o usúario ${usuario.nome}"),
        actions: [
          TextButton(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          child: ListTile(
                            leading: IconButton(
                              onPressed: () => _abrirForm(usuario: usuario),
